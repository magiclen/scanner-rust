...
fn next_lines() {
    ...
    assert_eq!(Some("123 中文好難。寝る"), sc.next_line().unwrap());
    assert_eq!(None, sc.next_line().unwrap());
    assert_eq!(None, sc.next_line().unwrap());
    assert_eq!(None, sc.next_line().unwrap());
    ...
    assert_eq!(Some("123 中文好難。"), sc.next_line().unwrap());
    assert_eq!(Some(""), sc.next_line().unwrap());
    assert_eq!(Some("寝る"), sc.next_line().unwrap());
    assert_eq!(Some(" "), sc.next_line().unwrap());
    assert_eq!(Some("123 中文好難。寝る"), sc.next_line().unwrap());
    assert_eq!(Some("Hello, "), sc.next_line().unwrap());
    assert_eq!(Some("world."), sc.next_line().unwrap());
    assert_eq!(None, sc.next_line().unwrap());
    assert_eq!(None, sc.next_line().unwrap());
    assert_eq!(None, sc.next_line().unwrap());
}
...
fn next_lines_crlf() {
    ...
    assert_eq!(Some("123"), sc.next_line().unwrap());
    ...
    assert_eq!(Some("中文"), sc.next_line().unwrap());
    assert_eq!(Some("123"), sc.next_line().unwrap());
    assert_eq!(Some("456"), sc.next_line().unwrap());
...
fn next_lines_chars() {
    ...
    assert_eq!(Some('H'), sc.next_char().unwrap());
    assert_eq!(Some("ello, 123"), sc.next_line().unwrap());
    assert_eq!(Some('中'), sc.next_char().unwrap());
    assert_eq!(Some('文'), sc.next_char().unwrap());
    assert_eq!(Some("好難。寝る"), sc.next_line().unwrap());
    assert_eq!(Some('\n'), sc.next_char().unwrap());
    assert_eq!(None, sc.next_char().unwrap());
}
